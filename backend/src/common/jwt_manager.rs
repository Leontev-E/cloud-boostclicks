...
impl AuthUser {
    pub fn new(id: Uuid, identifier: String) -> Self {
        Self { id, identifier }
    }
}
...
impl JWTManager {
    ...
    pub fn validate(token: &str, secret_key: &str) -> CloudBoostclicksResult<AuthUser> {
        ...
        decode::<Claims>(token, &decoding_key, &validation)
            .map(|token_data| {
                ...
                AuthUser::new(id, token_data.claims.identifier)
            })
