...
use crate::{
    common::password_manager::PasswordManager, errors::CloudBoostclicksResult, models::users::InDBUser,
...
impl<'d> UsersService<'d> {
    ...
    pub async fn create(&self, in_user: InUser) -> CloudBoostclicksResult<()> {
